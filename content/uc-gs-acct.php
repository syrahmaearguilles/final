	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$("#view-graduates").hide();
				$("#admin-gsacct").css("background-color","#000")
								  .css("color","#fff");
				$("#camp-grads").click(function(){
			...
			<div id = "sub-wrapper">
				...
				<div id = "content-admin">
					...
					<div id = "right-sidebar">
						<?php include "content/parts/right-sidebar-menu-gs-acct.php";?>
						<?php include "content/parts/right-sidebar-content-gsadmin.php";?>
					</div>
				</div>
				<div id = "footer"></div>
			</div>
