	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$("#search-add-orgcampmem").hide();
				$("#search-add-orgcampnonmem").hide();
				$("#view-orgcampmem").hide();
				$("#view-orgcampnonmem").hide();
				$("#orgadmin-campacct").css("background-color","#000")
								  .css("color","#fff");
				//non member
				$("#orgcamp-nonmem").click(function(){
					$("#search-add-orgcampnonmem").show("slow");
					$("#search-add-orgcampmem").hide();
					$("#view-orgcampnonmem").show("slow");
					$("#view-orgcampmem").hide();
					$("#orgcamp-nonmem").css("background-color","#000")
							  .css("color","#fff");
					$("#orgcamp-mem").css("background-color","#fff")
							  .css("color","#7C7C7C");
				});
				//member
				$("#orgcamp-mem").click(function(){
					$("#search-add-orgcampmem").show("slow");
					$("#search-add-orgcampnonmem").hide();
					$("#view-orgcampmem").show("slow");
					$("#view-orgcampnonmem").hide();
					$("#orgcamp-mem").css("background-color","#000")
							  .css("color","#fff");
					$("#orgcamp-nonmem").css("background-color","#fff")
							  .css("color","#7C7C7C");
				});
			});
		</script>
			...
			<div id = "sub-wrapper">
				...
				<div id = "content-admin">
					...
					<div id = "right-sidebar">				
						<?php include "content/parts/right-sidebar-menu-org-campus-acct.php";?>
						<?php include "content/parts/right-sidebar-content-orgcampusadmin.php";?>
						<?php include "content/parts/right-sidebar-content-orgcampusadminmem.php";?>
					</div>
				</div>
				<div id = "footer"></div>
			</div>
