	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$("#search-add-employee").hide();
				$("#view-employee").hide();
				$("#admin-acct").css("background-color","#000")
								  .css("color","#fff");
				$("#dept-emp").click(function(){
					$("#search-add-employee").show("slow");
					$("#view-employee").show("slow");
					$("#dept-emp").css("background-color","#000")
							  .css("color","#fff");	
				});
			});
		</script>
			...
			<div id = "sub-wrapper">
				...
				<div id = "content-admin">
					...
					<div id = "right-sidebar">
						<?php include "content/parts/right-sidebar-menu-dept-acct.php";?>
						<?php include "content/parts/right-sidebar-content-deptadmin.php";?>
					</div>
				</div>
				<div id = "footer"></div>
			</div>
