...
function SimpleTextEditor(id, objectId) {
    ...
    this.getEditorHtml = function() {
        ...
        html += '<table class="ste" cellspacing="0" border="0" cellpadding="0">';
        ...
        html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/bold.gif" width="20" height="20" alt="Bold" title="Bold" onclick="'+this.objectId+'.execCommand(\'bold\')"></td>';
        html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/italic.gif" width="20" height="20" alt="Italic" title="Italic" onclick="'+this.objectId+'.execCommand(\'italic\')"></td>';
        html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/underline.gif" width="20" height="20" alt="Underline" title="Underline" onclick="'+this.objectId+'.execCommand(\'underline\')"></td>';
        html += '<td><div class="separator"></div></td>';
        html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/left.gif" width="20" height="20" alt="Align Left" title="Align Left" onclick="'+this.objectId+'.execCommand(\'justifyleft\')"></td>';
        html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/center.gif" width="20" height="20" alt="Center" title="Center" onclick="'+this.objectId+'.execCommand(\'justifycenter\')"></td>';
        html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/right.gif" width="20" height="20" alt="Align Right" title="Align Right" onclick="'+this.objectId+'.execCommand(\'justifyright\')"></td>';
		html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/outdent.gif" width="20" height="20" alt="Outdent" title="Outdent" onclick="'+this.objectId+'.execCommand(\'outdent\')"></td>';
        html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/indent.gif" width="20" height="20" alt="Indent" title="Indent" onclick="'+this.objectId+'.execCommand(\'indent\')"></td>';
		html += '<td><div class="separator"></div></td>';
        html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/ol.gif" width="20" height="20" alt="Ordered List" title="Ordered List" onclick="'+this.objectId+'.execCommand(\'insertorderedlist\')"></td>';
        html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/ul.gif" width="20" height="20" alt="Unordered List" title="Unordered List" onclick="'+this.objectId+'.execCommand(\'insertunorderedlist\')"></td>';
		 //mao ni akong gi edit dapit
		html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/superscript.gif" width="20" height="20" alt="Superscript" title="Superscript" onclick="'+this.objectId+'.execCommand(\'superscript\')"></td>';
		html += '<td class="button"><img src="'+this.path+'libraries/src-js/images/subscript.gif" width="20" height="20" alt="Subscript" title="Subscript" onclick="'+this.objectId+'.execCommand(\'subscript\')"></td>';
		//dinhi to kutob
        //html += '<td><div class="separator"></div></td>';
