	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$("#search-add-fac").hide();
				$("#search-add-staff").hide();
				$("#search-add-stud").hide();
				$("#search-add-alum").hide();
				$("#view-fac").hide();
				$("#view-staff").hide();
				$("#view-stud").hide();
				$("#view-alum").hide();
				$("#admin-acct").css("background-color","#000")
								  .css("color","#fff");
				$("#col-fac").click(function(){
					$("#search-add-fac").show("slow");
					$("#search-add-staff").hide();
					$("#search-add-stud").hide();
					$("#search-add-alum").hide();
					$("#view-fac").show("slow");
					...
					$("#view-stud").hide();
					$("#view-alum").hide();
					$("#col-fac").css("background-color","#000")
							  .css("color","#fff");
					$("#col-staff").css("background-color","#fff")
							  .css("color","#7C7C7C");
					$("#col-stud").css("background-color","#fff")
							  .css("color","#7C7C7C");
					$("#col-alum").css("background-color","#fff")
							  .css("color","#7C7C7C");
				});
				$("#col-staff").click(function(){
					$("#search-add-staff").show("slow");
					$("#search-add-fac").hide();
					$("#search-add-stud").hide();
					$("#search-add-alum").hide();
					$("#view-staff").show("slow");
					$("#view-fac").hide();
					$("#view-stud").hide();
					$("#view-alum").hide();
					$("#col-staff").css("background-color","#000")
							  .css("color","#fff");
					$("#col-fac").css("background-color","#fff")
							  .css("color","#7C7C7C");
					$("#col-stud").css("background-color","#fff")
							  .css("color","#7C7C7C");	
					$("#col-alum").css("background-color","#fff")
				...
				$("#col-stud").click(function(){
					$("#search-add-stud").show("slow");
					$("#search-add-staff").hide();
					$("#search-add-fac").hide();
					$("#search-add-alum").hide();
					$("#view-stud").show("slow");
					...
					$("#view-fac").hide();
					$("#view-alum").hide();
					$("#col-stud").css("background-color","#000")
							  .css("color","#fff");
					$("#col-staff").css("background-color","#fff")
							  .css("color","#7C7C7C");
					$("#col-fac").css("background-color","#fff")
				...
				$("#col-alum").click(function(){
					$("#search-add-alum").show("slow");
					$("#search-add-staff").hide();
					$("#search-add-fac").hide();
					$("#search-add-stud").hide();
					$("#view-alum").show("slow");
					...
					$("#view-fac").hide();
					$("#view-stud").hide();
					$("#col-alum").css("background-color","#000")
							  .css("color","#fff");
					$("#col-staff").css("background-color","#fff")
							  .css("color","#7C7C7C");
					$("#col-stud").css("background-color","#fff")
			...
			<div id = "sub-wrapper">
				...
				<div id = "content-admin">
					...
					<div id = "right-sidebar">
						<?php include "content/parts/right-sidebar-menu-col-acct.php";?>
						<?php include "content/parts/right-sidebar-content-coladmin.php";?>
					</div>
				</div>
				<div id = "footer"></div>
			</div>
