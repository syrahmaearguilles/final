	...
	<head>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				$("#search-add-graduates").hide();
				$("#search-add-alum").hide();
				$("#view-graduates").hide();
				$("#view-alum").hide();
				$("#admin-acct").css("background-color","#000")
								  .css("color","#fff");
				$("#camp-graduates").click(function(){
					$("#search-add-graduates").show("slow");
					$("#search-add-alum").hide();
					$("#view-graduates").show("slow");
					$("#view-alum").hide();
					$("#camp-graduates").css("background-color","#000")
							  .css("color","#fff");
					$("#camp-alum").css("background-color","#fff")
							  .css("color","#7C7C7C");	
				});
				$("#camp-alum").click(function(){
					$("#search-add-graduates").hide();
					$("#search-add-alum").show("slow");
					$("#view-graduates").hide();
					$("#view-alum").show("slow");
					$("#camp-alum").css("background-color","#000")
							  .css("color","#fff");
					$("#camp-graduates").css("background-color","#fff")
							  .css("color","#7C7C7C");
				});
			});
		</script>
			...
			<div id = "sub-wrapper">
				...
				<div id = "content-admin">
					...
					<div id = "right-sidebar">				
						<?php /*include "content/parts/right-sidebar-menu-campus-acct.php";*/?>
						<?php include "content/parts/right-sidebar-content-campusadmin.php";?>
					</div>
				</div>
				<div id = "footer"></div>
			</div>
